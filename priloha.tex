...
Posléze otevøeme soubor \textit{/src/utisk/xml/SUMOXMLDefinitions.h} a pøidáme do seznamu parametrù\footnote{ideálnì vyhledat nìjaký stávajicí model - pro Krausse SUMO\_TAG\_CF\_KRAUSS\_ORIG1 a za nìj (ne místo nìj!) pøidat SUMO\_TAG\_CF\_GIPPS}.

V souboru \textit{/src/utisk/xml/SUMOXMLDefinitions.cpp} poté pøidáme opìt k sekci modelù Gippsùv - \textit{\{ "carFollowing-GIPPS",       SUMO\_TAG\_CF\_GIPPS \}}.
