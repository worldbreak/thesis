...
\label{chap:chi2test}
Je všeobecnì známým faktem, že vozidla se generují z exponenciálního rozdìlení za podmínky, že èetnosti poètu vozidel, které vjíždí do oblasti, mají Poissonovo rozdìlení. Bylo proto nutné tento pøedpoklad otestovat. Pro toto testování se používá $\chi^2$ test dobré shody.
...
V ranní špièce byly zjištìny hodnoty, které jsou shrnuty v tabulce \ref{tablerano}. Poèet stupòù volnosti $\chi^2$ rozdìlení je poèet tøídy - 1, v našem pøípadì to bude 8.
\begin{table}[h]
\begin{center}
\begin{tabular}{|c|c|c|}
\hline
...
Stanovíme si hypotézu $H_0$, že výbìr vozidel pochází z Poissonova rozdìlení se støední hodnotou $\mu = 3,75$.

Z èetností a oèekávaných èetností byla vypoètena statistika $\chi^2$,
\begin{equation}
\chi^2 = 7,56,
\label{eq:ci2stat}
\end{equation}

a kritická hodnota pro $\chi^2$ na hladinì významnosti 5\,\% byla rovna
\begin{equation}
\chi^2_{\text{krit};0,95;8} = 15,51.
\label{eq:ci2stat}
\end{equation} 

Je vidìt, že $\chi^2_{\text{krit};0,95;8} > \chi^2$ a z 5\% pravdìpodobností nezamítáme hypotézu, že se jedná o Poissonovo rozdìlení.

To sáme provedeme pro druhou èást dne mezi 15:00 -- 18:00 hodinou. Èetnosti jsou shrnuty v tabulce \ref{tableodpo}.
...
Stanovíme si hypotézu $H_0$, že výbìr vozidel pochází z Poissonova rozdìlení se støední hodnotou $\mu = 33,91$.
