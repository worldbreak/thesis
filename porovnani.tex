...
Jak ji bylo øeèeno v~podkapitole \ref{sec:IDM-rozdily}, IDM byl v~SUMO primárnì naprogramován v~urèitém módu, kde ovšem dosahoval velmi špatnıch vısledkù. Jak ji bylo øeèeno, bylo nutné model pøeprogramovat, aby dosahoval pøijatelnıch vısledkù. Pøeprogramování probìhlo nahrazením vıpoètu interakèního zrychlení v SUMO za interakèní zrychlení dle rovnice \eqref{intclen}. Po pøeprogramování ji IDM dosahoval pomìrnì kvalitních vısledkù. Na obrázku \ref{chyba170}d) pozorujeme zajímavı jev a to sice, e u~tohoto modelu jsou daleko vyšší hodnoty vıchylek do záporna, èásteènì to mùe bıt zpùsobeno problémem s~vjídìním vozidel do oblasti. Støední hodnota po velkém vıkyvu do zápornıch èísel se u~IDM na pár minut zvıší o~2--3 vozidla.
