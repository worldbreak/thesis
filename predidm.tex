...
Preferovaný odstup mezi stacionárními\footnote{nezávislé na èase} vozidly znaèíme AX. Tento práh sestává s délky èelního vozidla seètenou s preferovanou vzdáleností mezi vozidly. Je definován jako
\begin{equation}
...
\caption{Režimy Wiedemannova modely}%
\label{wiedemann}%
\end{figure}
