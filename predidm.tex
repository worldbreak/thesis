...
Pokud platí pro témìø všechna vozidla nižší hodnota v rovnici \eqref{eq:gipps} nerovnice \eqref{eq:nextreplace}, vozidla jedou blízko sebe, z èehož vyplývá vysoká hustota provozu. Pokud platí opak, tz. nerovnice \eqref{eq:inequalitygipps}, dopravní proud je volný.

Posun rychlosti mezi stavy $v(t)$ a $v(t+T_\n)$ 