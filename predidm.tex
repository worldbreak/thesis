...
$\tau_\n$ a $d_\n$ se znaènì liší mezi jednotlivými vozidly, protože nìkteøí øidièi radìji jedou blíže vozidlu pøed sebou (n-1) až na minimální bezpeènou vzdálenost, kdežto nìkteøí mají radi zase naopak velkou, aby byli schopni vklidu zareagovat. Je rozumné, aby se hodnoty $\tau_n$ a $d_\n$ lišily, a to tak, že každému jednotlivému vozidlu budou hodnoty vygenerovány z nìjakého pravdìpodobnostního rozdìlení, jehož variaèní koeficient se bude blížit jedné. Pøi generování vozidel za sebou 