...
Pro výpoèet zrychlení v IDM je použit vztah \rem{bacha na to, jak znaèíte derivace podle èasu, mìlo by to být všude stejnì}
\begin{equation}
v_{\n}(t + \Delta T) = v_\n (t) + a_\free + a_\inter,
\label{soucetzrych}
\end{equation}
...
\caption{Promìnné jednotlivých vozidel}%
\label{promen}%
\end{figure}
...
\caption{Režimy Wiedemannova modelu}%
\label{wiedemann}%
\end{figure}
