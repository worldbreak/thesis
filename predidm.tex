...
x^*_{\nm1} - s_{\nm1} < x_\n^*,
\]
kde $s_{\nm1}$ je délka vozidla $n-1$ seètena s bezpeènou vzdáleností následujícího ($n$) vozidla. Nicménì pokud tato podmínka neplatí, vozidlo nemá žádný prostor pro jeho pøípadnou chybu.  
