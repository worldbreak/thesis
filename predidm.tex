...
\begin{itemize}
	...
	\item $a_\n$ - maximální hodnota zrychlení, kterým je øidiè ochoten zrychlovat - nikoliv zrychlení vozidla v èase n!,
	\item $V_\n$ - preferovaná rychlost vozidla n,
	\item $b_\n$ - maximální decelerace vozidla, kterým je øidiè ochoten brzdit,
	\item $x_\n$ - poloha vozidla n
