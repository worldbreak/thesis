...
Hlavní zdroj pro $F$-test je použit \cite[str.111]{Pavlik}.
...
Dalším dùležitým ukazatelem je støední absolutní chyba\footnote{v odborné literatuøe oznaèována jako MAE (z~angl. Mean absolute error)} \cite{Willmott}, která je definována jako
\begin{equation}
