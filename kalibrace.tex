...
Statistické metody pro validaci modelù jsou vysvìtleny hlavnì v \cite{Kelton}, \cite{Aimsun} a \cite{Kleijnen}. Jako hlavní zdroj pro GEH formuli jsou použity zdroje \cite{Feldman} a \cite{CalibrationWWW}. Jak jsme zmínili v minulé sekci, budeme potøebovat dvì sady dat, jednu ke kalibraci modelu a druhou k validaci modelu.
